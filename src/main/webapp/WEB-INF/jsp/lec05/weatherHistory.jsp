            ...
            <div class="d-flex">
                <nav>
                    ...
                    <ul class="nav flex-column mt-4">
                        <li class="nav-item"><a href="/lec05/weather_history" class="nav-link main-link">날씨</a></li>
                        <li class="nav-item"><a href="/lec05/add_weather_view" class="nav-link main-link">날씨입력</a></li>
